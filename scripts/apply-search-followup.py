...
track_index_clear_count = renderer.count("trackSearchIndex.clear();")
...
for forbidden in (
    ...
    if forbidden in renderer:
        raise SystemExit(f"stale renderer search fragment remains: {forbidden}")
...
print("Applied the indexed search and Electron smoke-test follow-up.")
